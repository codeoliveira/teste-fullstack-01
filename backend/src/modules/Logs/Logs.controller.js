...
class LogsController {
    ...
    GET_ONE = async (req, res) => {
        ...
        const result = await Log.read({ '_seq': `${id}` }, {});
    ...
    LIST_ALL = async (req, res) => {
        ...
        const result = await Log.read(search, options, true);
    ...
    CREATE = async (req, res) => {
        ...
        Log.create(registro).then((result) => {
            ...
            if (result.error) {
                const ret = DadosStd.prepareReturn(
                    400,
                    false,
                    'ERRO: Falha ao adicionar nova log, tente novamente em alguns segundos',
                    null,
                    null,
                    null,
                    null
    ...
    PATCH = async (req, res) => {
        ...
        const result = await Log.read({ '_seq': `${id}` }, DadosStd.prepareFields({ _id: 1 }));
        ...
        const updated = await Log.patch(id, registro, { projection: DadosStd.prepareFields() });
        const ret = DadosStd.prepareReturn(
            200,
            true,
            'OK: Log atualizada com sucesso',
            updated,
            null,
            null,
            null
    ...
    PUT = async (req, res) => {
        ...
        const updated = await Log.update(id, registro, { projection: DadosStd.prepareFields() });
        const ret = DadosStd.prepareReturn(
            200,
            true,
            'Ok: Log substituida com sucesso',
            updated,
            null,
            null,
            null
    ...
    DELETE = async (req, res) => {
        ...
        if (deleted.ok) {
            ...
            ret = DadosStd.prepareReturn(
                400,
                false,
                'ERRO: Falha ao tentar remover a log, tente novamente em alguns segundos',
                null,
                null,
                null,
                null
