...
class Produto {
    ...
    #createLog = (action, dataAntes, dataDepois) => {
        ...
        const actions = {
            create: `Criou produto ${dataDepois._seq} - ${dataDepois.nome}`,
            update: `Atualizou produto ${dataAntes._seq} de (${dataAntes.nome}) para (${dataDepois.nome})`,
            delete: `Deletou produto ${dataAntes._seq} - ${dataAntes.nome}`
        }
