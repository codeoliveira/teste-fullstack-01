...
export default {
    ...
    methods: {
        ...
        ...mapActions('NS_categorias', ['getState', 'getAll', 'create', 'update', 'delete', 'countProducts']),


        async criarCategoria() {

            let categoria = this.form;

            try {
                let res = await this.create(categoria);
                let { data } = res;
